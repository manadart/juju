...
//
//	mockgen -package mocks -destination internal/worker/caasapplicationprovisioner/mocks/domain_mock.go github.com/juju/juju/internal/worker/caasapplicationprovisioner ApplicationService,StatusService,AgentPasswordService,StorageProvisioningService
//
...
// ClearK8sServiceAddresses mocks base method.
func (m *MockApplicationService) ClearK8sServiceAddresses(ctx context.Context, appUUID application.UUID) error {
	m.ctrl.T.Helper()
	return gomock.Dispatch2_1(&m.recorder.clearK8sServiceAddressesExpects, m.ctrl, m, "ClearK8sServiceAddresses", ctx, appUUID)
}

// ClearK8sServiceAddresses indicates an expected call of ClearK8sServiceAddresses.
func (mr *MockApplicationServiceMockRecorder) ClearK8sServiceAddresses(ctx, appUUID any) *MockApplicationServiceClearK8sServiceAddressesCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall2_1[context.Context, application.UUID, error](mr.mock.ctrl.T, mr.mock, "ClearK8sServiceAddresses", gomock.EnsureMatcher(ctx), gomock.EnsureMatcher(appUUID))
	mr.clearK8sServiceAddressesExpects = append(mr.clearK8sServiceAddressesExpects, call)
	mr.mock.ctrl.Track(call.Call)
	return call
}

// MockApplicationServiceClearK8sServiceAddressesCall is the typed call wrapper for ClearK8sServiceAddresses.
type MockApplicationServiceClearK8sServiceAddressesCall = gomock.Call2_1[context.Context, application.UUID, error]
