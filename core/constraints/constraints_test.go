...
var parseConstraintsTests = []struct {
	...
	// Everything at once.
	{
		...
		result: &constraints.Value{
			...
			Tags:             &[]string{"foo", "bar"},
			Spaces:           &[]string{"space1", "^space2"},
			InstanceRole:     new("foo2"),
			InstanceType:     new("foo"),
			VirtType:         new("kvm"),
			Zones:            &[]string{"az1", "az2"},
			AllocatePublicIP: new(false),
		},
	}, {
...
var constraintsRoundtripTests = []roundTrip{
	...
	{"Arch1", constraints.Value{Arch: new("")}},
	{"Arch2", constraints.Value{Arch: new("amd64")}},
	...
	{"CpuCores2", constraints.Value{CpuCores: new(uint64(0))}},
	{"CpuCores3", constraints.Value{CpuCores: new(uint64(128))}},
	{"CpuPower1", constraints.Value{CpuPower: nil}},
	{"CpuPower2", constraints.Value{CpuPower: new(uint64(0))}},
	{"CpuPower3", constraints.Value{CpuPower: new(uint64(250))}},
	{"Mem1", constraints.Value{Mem: nil}},
	{"Mem2", constraints.Value{Mem: new(uint64(0))}},
	{"Mem3", constraints.Value{Mem: new(uint64(98765))}},
	{"RootDisk1", constraints.Value{RootDisk: nil}},
	{"RootDisk2", constraints.Value{RootDisk: new(uint64(0))}},
	{"RootDisk2", constraints.Value{RootDisk: new(uint64(109876))}},
	{"RootDiskSource1", constraints.Value{RootDiskSource: nil}},
	{"RootDiskSource2", constraints.Value{RootDiskSource: new("identikit")}},
	...
	{"InstanceRole1", constraints.Value{InstanceRole: new("")}},
	{"InstanceRole2", constraints.Value{InstanceRole: new("foo")}},
	{"InstanceType1", constraints.Value{InstanceType: new("")}},
	{"InstanceType2", constraints.Value{InstanceType: new("foo")}},
